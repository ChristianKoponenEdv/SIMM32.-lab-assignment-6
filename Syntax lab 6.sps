...
*note that nominal variables has histograms etc added, simply disregard descriptievs not fit for nominal variables.
...
* the curse of dimensionality... what happens if a regression is fitted with 28 predictors?
...
* excluded 5 cases due to the risk of multivariate outliers, see paper for rationale. 

COMPUTE pval=($CASENUM-0.5)/145.
EXECUTE.
...
save results /outfile= 'C:\Users\chris\OneDrive\Dokument\screedata.sav' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= 'C:\Users\chris\OneDrive\Dokument\screedata.sav'.
TSPLOT VARIABLES= rawdata means percntyl /ID= root /NOLOG.

* --------------------------------------------------------------------- Parallel analysis ends.

*two to 4 factors maybe?! ... will test below.
...
* ---------- above are the three different number of factors to consider. 
* below I have started to use rotations.. and try to work with excluding different variables...
...
FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar19 
    ar20 ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar19 
    ar20 ar23 ar24 ar25 ar26 ar27
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION ROTATION
  /FORMAT BLANK(.30)
  /PLOT EIGEN
...
FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar15 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar26 ar27 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar15 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar26 ar27 ar28
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION ROTATION
  /FORMAT BLANK(.30)
  /PLOT EIGEN
...
* next I will try to exclude all variables with a value < than 0,4 in factor 1... 

FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar13 ar15 ar17 ar18 ar19 
    ar20 ar21 ar23 ar24 ar25 ar26 ar27 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar13 ar15 ar17 ar18 ar19 
    ar20 ar21 ar23 ar24 ar25 ar26 ar27 ar28
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION ROTATION
  /FORMAT BLANK(.30)
  /PLOT EIGEN
...
* and after excluding the lowest in factor 1; next I exclude the three lowest values!

FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar13 ar15 ar17 ar18 
    ar20 ar23 ar24 ar25 ar26 ar27 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar13 ar15 ar17 ar18 
    ar20 ar23 ar24 ar25 ar26 ar27 ar28
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION ROTATION
  /FORMAT BLANK(.30)
  /PLOT EIGEN
...
* below I saved the values for the regression.

FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar13 ar15 ar17 ar18 ar20 ar23 ar24 ar25 ar26 
    ar27 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar13 ar15 ar17 ar18 ar20 ar23 ar24 ar25 ar26 ar27 
    ar28
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION ROTATION
  /FORMAT BLANK(.30)
  /PLOT EIGEN
